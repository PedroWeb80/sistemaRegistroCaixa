...
<body style="background-color:#051f45;" class="text-light">
        ...
        <div class="row">
            ...
            <div class="col-11">
                <div class="bg-custom p-3 rounded mb-2 d-flex">
                    ...
                    <h3 class="m-2 text-aling-center col-11"><?= !empty($title) ? $title : "Sistema caixa" ?></h3>
                    <div class=" mt-2">
    ...
    <footer class="bg-custom p-5 mt-1 text-center">Todos diretos reservados: <a href="pedro.gtx@gmail.com">Pedro
            Daniel</a></footer>
